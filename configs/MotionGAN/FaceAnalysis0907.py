...
train = dict(
    ...
    out = 'results/MotionGAN/FaceAnalysis0918',

    # Dataset
    dataset=dict(
        data_root = '/home/takeuchi/data/RAVDESS_processed/Homography/train',
        multi_class = True,
...
evalc = dict(
    out = 'results/MotionGAN/FaceAnalysis0918',
    dataset=dict(
        data_root = '/home/takeuchi/data/RAVDESS_processed/Homography/test',
        class_list = ["neutral", "calm", "happy", "sad", "angry", "fearful", "disgust", "surprised"],
        start_offset = 1,
        control_point_interval = 8,
        standard_bvh = None,
