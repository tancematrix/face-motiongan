...
def test():
    ...
    for source_path in npy_source_paths:
        ...
        # control = Variable(control_data).to(device)
        ...
        x_motion = x_motion.numpy().squeeze().T
        ...
        for fake_label in range(len(cfg.train.dataset.class_list)):
            ...
            fake_rot, fake_bias, x_fake = gen(gt_motion, z, fake_label)
            ...
            fake_motion = x_fake.to("cpu").detach()
